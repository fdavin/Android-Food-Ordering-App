...
import com.majika.databinding.FragmentPembayaranBinding
...
class PembayaranFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textView: TextView = binding.textPembayaran
        pembayaranViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
